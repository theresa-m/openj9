					...
					if (valueTypeHelper.isFlattenableFieldSignature(J9ROMFieldShapeHelper.getSignature(f))
						...
						if (!valueTypeHelper.isJ9FieldIsFlattened(fieldClass, f)) {
							...
							if (fj9object_t_SizeOf == U32.SIZEOF) {
								UDATA instanceSize = J9BuildFlags.J9VM_OPT_VALHALLA_COMPACT_LAYOUTS ? fieldClass.flatFieldSize() : fieldClass.totalInstanceSize();
							...
							if (forceDoubleAlignment
								...
								UDATA flatFieldSize = J9BuildFlags.J9VM_OPT_VALHALLA_COMPACT_LAYOUTS ? fieldClass.flatFieldSize() : fieldClass.totalInstanceSize();
								if (!J9BuildFlags.J9VM_OPT_VALHALLA_COMPACT_LAYOUTS
									&& valueTypeHelper.classRequires4BytePrePadding(fieldClass)
								) {
								...
								size = Scalar.roundToSizeToFJ9object(J9BuildFlags.J9VM_OPT_VALHALLA_COMPACT_LAYOUTS ? fieldClass.flatFieldSize() : fieldClass.totalInstanceSize()).intValue();
								...
								size = Scalar.roundToSizeofU32(J9BuildFlags.J9VM_OPT_VALHALLA_COMPACT_LAYOUTS ? fieldClass.flatFieldSize() : fieldClass.totalInstanceSize()).intValue();
