...

				{
					...
					if (flags & J9FieldSizeDouble) {
						...
						*(U_32*)_sp = _objectAccessBarrier.inlineMixedObjectReadU8(_currentThread, objectref, newValueOffset, isVolatile);
						...
						_sp += (slotsToPop - 1);
						*(U_32*)_sp = _objectAccessBarrier.inlineMixedObjectReadI8(_currentThread, objectref, newValueOffset, isVolatile);
						...
						*(U_32*)_sp = _objectAccessBarrier.inlineMixedObjectReadU16(_currentThread, objectref, newValueOffset, isVolatile);
						...
						_sp += (slotsToPop - 1);
						*(U_32*)_sp = _objectAccessBarrier.inlineMixedObjectReadI16(_currentThread, objectref, newValueOffset, isVolatile);
