...
#define J9_VM_FCC_CLASS_FLAGS_STRICT_STATIC_FIELD_IS_PRIMITIVE ((UDATA)0x8)
...
#define J9_VM_FCC_ENTRY_IS_STRICT_STATIC_PRIMITIVE(entry) J9_ARE_ALL_BITS_SET((UDATA)(entry)->clazz, J9_VM_FCC_CLASS_FLAGS_STRICT_STATIC_FIELD_IS_PRIMITIVE)
